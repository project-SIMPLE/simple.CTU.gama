...
//	date the_date <- date([2010, 1, 1]);
	...
	bool use_profile_adaptation<-true;// parameter:"use_profile_adaptation"
	bool use_subsidence_macro<-true;// parameter:"use_subsidence_macro"
	bool use_subsidence<-false;// parameter:"use_subsidence"
