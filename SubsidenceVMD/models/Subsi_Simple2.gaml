...
global {
	...
	grid_file dem_file1 <- grid_file("../includes/groundwater/1_volume_qh.tif");
	grid_file dem_file2 <- grid_file("../includes/groundwater/2_volume_qp3.tif");
	grid_file dem_file3 <- grid_file("../includes/groundwater/3_volume_qp23.tif");
