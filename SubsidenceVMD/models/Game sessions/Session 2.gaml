	...
	output {
		...
		/////P1
			...
			graphics "image1" refresh: false size: player_size position: player_1_position {
				...
				draw "Sụt lún: " + (mean(cell collect each.subsidence(GPlayLand[nP].playerLand_ID))) at: {-20000, 58000} font: font("Helvetica", 24, #bold) color: #red;
				draw "Time: " + current_date.hour + ":" + current_date.minute at: {-20000, 78000} font: font("Helvetica", 24, #bold) color: #red;
				draw "" + (length(unity_player) > 0 ? (unity_player[nP].name) : "") at: {-20000, 98000} font: font("Helvetica", 24, #bold) color: #red;
			}
			...
			graphics "image2" refresh: false size: player_size position: player_2_position {
				...
				draw "Sụt lún: " + (mean(cell collect each.subsidence(GPlayLand[nP].playerLand_ID))) at: {3e5, 58000} font: font("Helvetica", 24, #bold) color: #red;
				draw "Time: " + current_date.hour + ":" + current_date.minute at: {3e5, 78000} font: font("Helvetica", 24, #bold) color: #red;
				draw "" + (length(unity_player) > 1 ? (unity_player[nP].name) : "") at: {3e5, 98000} font: font("Helvetica", 24, #bold) color: #red;
			}
			...
			graphics "image3" refresh: false size: player_size position: player_3_position {
				...
				draw "Sụt lún: " + (mean(cell collect each.subsidence(GPlayLand[nP].playerLand_ID))) at: {-20000, 58000} font: font("Helvetica", 24, #bold) color: #yellow;
				draw "Time: " + current_date.hour + ":" + current_date.minute at: {-20000, 78000} font: font("Helvetica", 24, #bold) color: #yellow;
				draw "" + (length(unity_player) > 2 ? (unity_player[nP].name) : "") at: {-20000, 98000} font: font("Helvetica", 24, #bold) color: #yellow;
			}
			...
			graphics "image4" refresh: false size: player_size position: player_4_position {
				int nP <- 3;
				draw rectangle(world.shape.height * 1177 / 1421, world.shape.height) texture: image_file("../includes/scene.png");
				draw "Cây chết: " + ((GPlayLand[nP].deadtrees)) font: font("Helvetica", 24, #bold) at: {3e5, 100} color: #yellow;
				draw "Nước sạch: " + (length(GPlayLand[nP].fresh_waters.values)) font: font("Helvetica", 24, #bold) at: {3e5, 18000} color: #yellow;
				draw "Máy bơm: " + (length(GPlayLand[nP].pumpers.values)) font: font("Helvetica", 24, #bold) at: {3e5, 38000} color: #yellow;
				draw "Sụt lún: " + (mean(cell collect each.subsidence(GPlayLand[nP].playerLand_ID))) at: {3e5, 58000} font: font("Helvetica", 24, #bold) color: #yellow;
				draw "Time: " + current_date.hour + ":" + current_date.minute at: {3e5, 78000} font: font("Helvetica", 24, #bold) color: #yellow;
				draw "" + (length(unity_player) > 3 ? (unity_player[nP].name) : "") at: {3e5, 98000} font: font("Helvetica", 24, #bold) color: #yellow;
			}
